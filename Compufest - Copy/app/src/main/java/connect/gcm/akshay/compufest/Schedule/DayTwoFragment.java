 ...
 */
public class DayTwoFragment extends ListFragment {
    ArrayList<Schedule> arr_list;
    RequestQueue requestQueue;
    StringRequest stringRequest;
    ScheduleAdaptor scheduleAdaptor;
    private final String URL1="http://ycce.hosting.acm.org/compufest/schedule_day2.php";
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        try {
                            ...
                            arr_list.add(new Schedule(17, event_name, event_place, event_time));
