...
public class TechnicalActivity extends AppCompatActivity implements ExpandingFragment.OnExpandingClickListener {
    @Bind(R.id.viewPager)
    ViewPager viewPager;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(TechnicalActivity.this, "Workshop Activity Called", Toast.LENGTH_SHORT).show();
    ...
    private List<Travel> generateTravelList() {
        ...
        for (int i = 0; i < 5; ++i) {
            travels.add(new Travel("9","Core Montere", R.drawable.core));
            travels.add(new Travel("10","ConsoleX", R.drawable.console));
            travels.add(new Travel("11","Mini Militia", R.drawable.graphix_workshop));
            travels.add(new Travel("12","Tech Hunt", R.drawable.graphix_workshop));
        }
        return travels;
    }
