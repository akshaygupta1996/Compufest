...
public class CulturalActivity extends AppCompatActivity implements ExpandingFragment.OnExpandingClickListener {
    @Bind(R.id.viewPager)
    ViewPager viewPager;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(CulturalActivity.this, "Workshop Activity Called", Toast.LENGTH_SHORT).show();
    ...
    private List<Travel> generateTravelList() {
        ...
        for (int i = 0; i < 5; ++i) {
            travels.add(new Travel("6","Enthusia", R.drawable.entuziaa));
            travels.add(new Travel("7","Fb Fever", R.drawable.fb));
            travels.add(new Travel("8","Selfie Mania", R.drawable.selphi));
        }
        return travels;
    }
